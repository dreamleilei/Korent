...
<div id="mess">
  ...
  <div id="case1">
    ...
    <div id="text1">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="submit" type="button"  class="fix" style="width:100px; height:30px; color:#FFFFFF; "  onclick=""  value="下架"/>
  ...
  <div id="case6">
    ...
    <div id="text6">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id = "cut" name="submit" type="button"  class="fix" style="width:100px; height:30px; color:#FFFFFF; " onclick=""  value="下架"/>
...
<script type="text/javascript" >
  ...
  function createPage(pageModel) {
    ...
    for (var i = 1; i <= pageModel.pageCount; i++) {
      model += "<a href=\"/userSendGoods.jsp?pageNo=" + i + "\&pageSize=6\" ><span>" + i + "&nbsp;&nbsp;</span></a>";
    }

    $('#spanFirst').parent().attr("href", "/userSendGoods.jsp?pageNo=1&pageSize=6");
    $('#spanLast').parent().attr("href", "/userSendGoods.jsp?pageNo=" + pageModel.pageCount + "&pageSize=6");
    $('#spanNext').parent().attr("href", "/userSendGoods.jsp?pageNo=" + (pageModel.pageNo + 1 ) +"&pageSize=6");
    $('#spanPre').parent().attr("href", "/userSendGoods.jsp?pageNo=" + (pageModel.pageNo - 1 ) +"&pageSize=6");
    $('#add').append(model);
  ...
  function createRent(rent_array){
    for(var i = 1; i <= rent_array.length; i++){
      ...
      $('#img'+i).children('a').attr("href", "/userSendInformation.jsp?rid=" + rent_array[i -1 ].id);
