...
<div id="mess">
  ...
  <div  id="button1" >
  <input name="submit" type="button" id="delete" class="fix" style="width:120px; height:60px; color:#FFFFFF; " onclick="" value="删除"/>
</div>
</div>
...
<script type="text/javascript">
  function createPage (data) {
    ...
    $('#delete').click(function () {
      var button = $(this);
      $.ajax({
        url: "/admin/deleteRentGoods.action",
        ...
        success: function () {
          ...
          button.val("成功删除");
          operateSuccessTip();
          $(this).delay(2000).queue(function(){  window.location.href="/adminRent.jsp";});
